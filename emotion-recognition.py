...
#emotion_model_path = 'models/ResNet-50.h5'
#emotion_model_path = 'models/weights-200-0.62_d.h5'
emotion_model_path = 'models/s_gpu3.h5'
    ...
    for face_coordinates in faces:
        ...
        if emotion_prediction is not None:
            ...
            for index, emotion in enumerate(emotion_labels):
                cv2.putText(rgb_image, emotion, (10, index * 20 + 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1)
                cv2.rectangle(rgb_image, (130, index * 20 + 10), (130 + int(emotion_prediction[0][index] * 100), (index + 1) * 20 + 4), (255, 0, 0), -1)
